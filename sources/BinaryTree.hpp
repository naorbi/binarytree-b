...
namespace ariel{
        ...
        public:
            ...
            preOrder_iterator &operator++() {
                if (currentNode == nullptr) {
                    throw std::invalid_argument("cannot move anymore");
                }
    ...
    public:
        ...
        BinaryTree& add_left(const T& exist_node,const T& InsertNode)
        {
            Node *helpNode = isInTree(this->root,exist_node);
        ...
        BinaryTree& add_right(const T& exist_node,const T& rightIn)
        {
            Node *helpNode = isInTree(root,exist_node);
